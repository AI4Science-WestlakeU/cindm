...
if __name__ == "__main__":
    # root = "./optimized_traj_fno_BP/" # the folder of two cell in Table 3
    # root = "./optimized_traj_lepde_BP/" # the folder of two cell in Table 3
    # root = "./optimized_traj_fno_BP_twobds/" # the folder of two cell in Table 3
    # root = "./optimized_traj_lepde_BP_twobds/" # the folder of two cell in Table 3
    # root = "./optimized_traj_lepde_CEM/" # the folder of two cell in Table 3
    # root = "./optimized_traj_fno_CEM/" # the folder of two cell in Table 3
    # root = "./optimized_traj_fno_CEM_twobds/"
    # root = "./optimized_traj_lepde_CEM_twobds/"
